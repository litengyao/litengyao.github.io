...
<template>
  <div class="min-h-screen bg-slate-50 pt-24 pb-12 animate-fade-in-up">
    <div class="max-w-5xl mx-auto px-6">
      ...
      <!-- Controls -->
      <div
        class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 mb-10 sticky top-24 z-20 backdrop-blur-md bg-white/90">
        <div class="flex flex-col md:flex-row gap-4 justify-between items-center">

          <!-- Year Filter -->
          <div class="flex flex-wrap justify-center gap-2">
            <button v-for="year in years" :key="year" @click="selectedYear = year" :class="[
          ...
          <div class="relative w-full md:w-72">
            ...
            <input v-model="searchQuery" type="text" placeholder="Search by title, author, or venue..."
      ...
      <div class="space-y-12">
        ...
        <!-- Empty -->
        <div v-else-if="filteredPubs.length === 0"
        ...
        <div v-else v-for="group in groupedPubs" :key="group.year" class="relative">
          ...
          <!-- Items -->
          <div class="space-y-6">
            <article v-for="pub in group.pubs" :key="pub.id"
              ...
              <!-- Highlight Badge -->
              <div v-if="pub.highlight"
                class="absolute top-0 right-0 bg-accent text-white text-xs font-bold px-3 py-1 rounded-bl-lg">
                Highlight
              </div>
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-wrap gap-3 pt-2">
                  ...
                  <button v-if="pub.bibtex" @click="copyBibtex(pub)"
      ...
      <!-- Footer Count -->
      <div v-if="!loading && filteredPubs.length > 0"
        class="mt-16 text-center text-sm text-slate-500 border-t border-slate-200 pt-8">
